    ...
    <div class="container">
        <div class="row mt-1">
            <div class="col-12 col-md-6 justify-content-center">
                ...
                <form 
                method="POST" 
                action="{{ route('post.update', compact('post')) }} "
                ...
                >
                    ...
                    <div class="mb-3">
                        ...
                        <input name="subtitle" type="text" class="form-control" id="subtitle" value="{{ $post->subtitle }}">
                    </div>

                    <div class="mb-3">
                        <label for="body" class="form-label">Corpo dell'Articolo</label>
                        <textarea name="body" class="form-control" id="body" cols="20" rows="8">{{ $post->body }}</textarea>
                    </div>
